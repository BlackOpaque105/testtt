...
export function sortItemsByDateDesc(itemA: CollectionEntry<'poem' | 'trips'>, itemB: CollectionEntry<'poem' | 'trips'>) {
    return new Date(itemB.data.publishDate).getTime() - new Date(itemA.data.publishDate).getTime();
}

export function getAllTags(posts: CollectionEntry<'poem'>[]) {
